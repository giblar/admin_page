...
const Update = ({ item, onUpdate }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append('NamaProfile', updatedItem.NamaProfile);
    ...
    try {
      const response = await axios.put(`${apiUrl}/profile/${item.Profile_id}`, formData, {
        headers: {
      ...
      console.error(`Error updating item with ID ${item.Profile_id}:`, error);
